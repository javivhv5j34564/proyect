            ...
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-3 md:gap-4 relative">
                ...
                <nav className="hidden md:flex items-center gap-6 font-semibold text-sm text-slate-600 dark:text-slate-400">
                    ...
                    <div className="relative group">
                        <button className="hover:text-purple-600 dark:hover:text-purple-400 transition-colors flex items-center gap-1.5"><Sparkles className="w-4 h-4 text-purple-500" /> Descubrir</button>
                        <div className="absolute top-full left-0 pt-2 w-56 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50">
                            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-xl flex flex-col overflow-hidden">
                                <Link to="/compare" className="px-4 py-3 hover:bg-slate-50 dark:hover:bg-slate-800 flex items-center gap-2 text-slate-700 dark:text-slate-300"><ArrowLeftRight className="w-4 h-4 text-blue-500"/> Comparador</Link>
                                <Link to="/matchmaker" className="px-4 py-3 hover:bg-slate-50 dark:hover:bg-slate-800 flex items-center gap-2 text-slate-700 dark:text-slate-300"><Target className="w-4 h-4 text-rose-500"/> MatchMaker Trivago</Link>
                                <Link to="/automation-risk" className="px-4 py-3 hover:bg-slate-50 dark:hover:bg-slate-800 flex items-center gap-2 text-slate-700 dark:text-slate-300"><ShieldAlert className="w-4 h-4 text-amber-500"/> Riesgo vs IAs</Link>
                                <Link to="/stack-builder" className="px-4 py-3 hover:bg-slate-50 dark:hover:bg-slate-800 flex items-center gap-2 text-slate-700 dark:text-slate-300"><Layers className="w-4 h-4 text-indigo-500"/> Flow Builder</Link>
                            </div>
                        </div>
                    </div>
                            ...
                            >
                                <div className="flex flex-col p-4 gap-2">
                                    ...
                                    <div className="w-full rounded-xl border border-purple-100 dark:border-purple-900/50 bg-purple-50/50 dark:bg-purple-900/10 p-2 space-y-2">
                                        <div className="text-xs font-bold text-purple-600 dark:text-purple-400 text-center uppercase tracking-wider mb-2 pt-2">Herramientas Pro</div>
                                        <Link to="/compare" onClick={() => setIsMobileMenuOpen(false)} className="w-full text-center px-4 py-2 font-semibold text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-900 rounded-lg flex items-center justify-center gap-2 border border-slate-100 dark:border-slate-800"><ArrowLeftRight className="w-4 h-4 text-blue-500"/> Comparador</Link>
                                        <Link to="/matchmaker" onClick={() => setIsMobileMenuOpen(false)} className="w-full text-center px-4 py-2 font-semibold text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-900 rounded-lg flex items-center justify-center gap-2 border border-slate-100 dark:border-slate-800"><Target className="w-4 h-4 text-rose-500"/> MatchMaker Trivago</Link>
                                        <Link to="/automation-risk" onClick={() => setIsMobileMenuOpen(false)} className="w-full text-center px-4 py-2 font-semibold text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-900 rounded-lg flex items-center justify-center gap-2 border border-slate-100 dark:border-slate-800"><ShieldAlert className="w-4 h-4 text-amber-500"/> Riesgo vs IAs</Link>
                                        <Link to="/stack-builder" onClick={() => setIsMobileMenuOpen(false)} className="w-full text-center px-4 py-2 font-semibold text-slate-700 dark:text-slate-300 bg-white dark:bg-slate-900 rounded-lg flex items-center justify-center gap-2 border border-slate-100 dark:border-slate-800"><Layers className="w-4 h-4 text-indigo-500"/> Flow Builder</Link>
                                    </div>
